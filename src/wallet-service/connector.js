    ...
    return (
      <div style={{ margin: "20px" }}>
        ...
        <div style={{ paddingTop: "10px" }}>
          ...
          {!localStorage.getItem("usedWallet") ? (
            this.walletsSuported.map((wallet) => {
              return this.state.wallets.includes(wallet) ? (
                ...
                <div key={wallet} className={css.walletPretty}>
                  <a
                    href={this.sendWebsite(wallet)}
                    target="_blank"
                    className={css.links}
                    rel="noreferrer"
                    alt={wallet}
                  >
                    <button type="button" key={wallet} className={css.button}>
                      <img
                        src={require(`..//assets/wallets/${wallet}.png`)}
                        alt={wallet}
                      />
                      <span>{wallet.toUpperCase()}</span>
                    </button>
        ...
        <button style={{ padding: "20px" }} onClick={this.clearAll}>
          SHOW ME
        </button>
